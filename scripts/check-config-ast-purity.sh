...
#
#   "dry.toml" | "dry4ts.toml" | "dry4rs" | "dry4ts"
#
...
#   test asserts the literal `"dry.toml"` IS the workspace-root
...
REJECTED='"dry\.toml"|"dry4ts\.toml"|"dry4rs"|"dry4ts"'
...
Fix: replace literal `"dry.toml"` with `TEST_META.config_file_name`
